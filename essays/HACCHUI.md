...
## What is HACC-Hui?
Information about Hacc-Hui: [HACC-Hui](https://hacc-hui.github.io/). [Github](https://hacc-hui.github.io/)
  ...
  topics such as skills, tools or challenges. </p>
...
## My Milestone Functionality
  ...
  by me and my team member Angeli. To configure the challenges, tools and skills you had to route to the database that held these respective topics and fetch 
  them respectively, creating an administrator component which would then be pulled through by the administrator page.
...
[Github Page](https://github.com/HACC-Hui/HACC-Hui/blob/master/app/imports/ui/components/administrator/ManageHaccWidget.jsx). 
  ...
  sort through the list of teams by challenges, skills or tools. I created a best fit team page pulls from the a component widget that lists all the teams. The functionality of sorting through these teams was however pulled from another group as I had issues with mine. The general functionality of the sorting was done through retrieving all the developers from each team, finding all the teams through a team ID, and having an intersection through the teams topic ID (challenges, tools and skills) respective to the list of topics. </p>
